...
int main() {
    ...
    Patient p1(1001, "John", 23, "Flu", 101);
    Patient p2(1002, "Alice", 30, "COVID-19", 102);
    Patient p3(1003, "Bob", 40, "Asthma", 103);
    ...
    h1.searchPatient("Alice");
    
    cout << "\nDeleting patient with ID 1002 (Alice):\n";
